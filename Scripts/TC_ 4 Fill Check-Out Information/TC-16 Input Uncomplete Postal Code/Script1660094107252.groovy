...
WebUI.setText(findTestObject('Checkout/TC-17/Page_Swag Labs/input_Checkout Your Informatio_14'), 'Azra')

WebUI.click(findTestObject('Checkout/TC-17/Page_Swag Labs/input_CANCEL_btn_primary cart_'))

WebUI.verifyElementPresent(findTestObject('Page_Swag Labs/div_Error Postal Code is required'), 0)
