...
WebUI.setText(findTestObject('Login/TC-03/Page_Swag Labs/input_standard_userlocked_out_'), 'asdrtfg')

WebUI.setEncryptedText(findTestObject('Login/TC-03/Page_Swag Labs/input_standard_userlocked_out__1'), 'qcu24s4901FyWDTwXGr6XA==')
