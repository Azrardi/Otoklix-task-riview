...
WebUI.setText(findTestObject('Checkout/TC-22/Page_Swag Labs/input_standard_userlocked_out_'), 'standard_user')

WebUI.setEncryptedText(findTestObject('Checkout/TC-22/Page_Swag Labs/input_standard_userlocked_out__1'), 'qcu24s4901FyWDTwXGr6XA==')

WebUI.click(findTestObject('Checkout/TC-22/Page_Swag Labs/input_standard_userlocked_out__3'))

WebUI.click(findTestObject('Page_Swag Labs/button_Add to cart'))

WebUI.click(findTestObject('Checkout/TC-22/Page_Swag Labs/a_Continue Shopping'))

WebUI.click(findTestObject('Product List/TC-10/Page_Swag Labs/button_Add to cart_1_2'))
